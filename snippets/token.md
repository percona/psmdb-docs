...
5. A token will be generated for you. You will also see the Client ID. Copy both the Client ID and the token as you will use them to configure the Pro repository and install the software.
