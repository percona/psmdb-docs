...
* Security vulnerability `CVE-2022-3602 <https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-3602>`_ is fixed for |PSMDB| installed from tarballs on Ubuntu 22.04.
...
To upgrade to |PSMDB|, see our :ref:`upgrade instructions <upgrade_from_50>`.
