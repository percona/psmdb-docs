...
|PSMDB| |release| is based on `MongoDB 4.2.5
<https://docs.mongodb.com/manual/release-notes/4.2/#mar-26-2020>`_.

Improvements
================================================================================

- :psmdb-bug:`PSMDB-165`: LDAP Authorization. Starting from release
...
.. |release| replace:: 4.2.5-5
.. |date| replace:: April 2, 2020
