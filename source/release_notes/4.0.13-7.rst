...
|PSMDB| |release| is based on `MongoDB 4.0.13
<https://docs.mongodb.com/manual/release-notes/4.0/#oct-19-2019>`_.

Bugs Fixed
================================================================================

- :psmdb-bug:`447`: The license for RPM and DEB packages has been changed from AGPLv3 to SSPL.

.. |release| replace:: 4.0.13-7
.. |date| replace:: November 31, 2019
