...
fully-compatible, drop-in replacement for `MongoDB 5.0.14 Community Edition <https://www.mongodb.com/docs/v5.0/release-notes/5.0/#5.0.14---nov-21--2022>`_.
...
* `SERVER-70879 <https://jira.mongodb.org/browse/SERVER-70879>`_ - Corrected a potential race condition where multiple writing threads can update collection metadata in a way where overwrites could possibly happen. This could cause data/documents to be either unavailable or lost.
...
* `SERVER-61185 <https://jira.mongodb.org/browse/SERVER-61185>`_ - Improved the performance of inserts into unique indexes
...
Find the full list of changes in the `MongoDB 5.0.14 Community Edition < release notes <https://www.mongodb.com/docs/v5.0/release-notes/5.0/#5.0.14---nov-21--2022>`_.
