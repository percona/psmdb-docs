...
|PSMDB| |release| introduces the support of |vault| key management
service. For more information, see
:ref:`psmdb.data-at-rest-encryption` in the documentation of |PSMDB|.

This release `includes all features
<https://docs.mongodb.com/manual/release-notes/4.0>`_ of |mongodb-ce|. Most notable among these are:
...
|PSMDB| |release| is based on `MongoDB 4.0.10
<https://docs.mongodb.com/manual/release-notes/4.0/#may-31-2019>`_.

New Features
================================================================================

- :psmdb-bug:`322`: |vault| support

.. |release| replace:: 4.0.10-5
.. |date| replace:: June 13, 2019
