...
fully-compatible, drop-in replacement for MongoDB 4.4.18 Community Edition enhanced :ref:`with enterprise-grade features <compare>`. 
...
* `SERVER-69443 <https://jira.mongodb.org/browse/SERVER-69443>`_ - Disallowed the use of the ``allowSpeculativeMajorityReads`` flag for the ``find`` command in transactions
...
* :jirabug:`PSMDB-1177`: Fixed incremental backup failure via $backupCursor for |PSMDB| 4.2/4.4
