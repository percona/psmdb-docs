...
.. note:: 
   ...
   Please refer to `Configure SELinux <https://docs.mongodb.com/v4.4/tutorial/install-mongodb-on-red-hat/#configure-selinux>` section of MongoDB Documentation for policy configuration guidelines. 
