...
.. note:: You can also `download packages <https://www.percona.com/downloads/percona-server-mongodb/LATEST/>`_ from the Percona website and install them manually using :command:`dpkg` or :command:`rpm`.
