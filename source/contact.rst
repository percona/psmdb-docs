...
use the `GitHub repo <https://github.com/percona/percona-server-mongodb>`_ and the `Contributing guide <https://github.com/percona/percona-server-mongodb/blob/v4.4/CONTRIBUTING.rst>`_.
