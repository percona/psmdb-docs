...
use the `GitHub repo <https://github.com/percona/percona-server-mongodb>`_ and the `Contributing guide <https://github.com/percona/percona-server-mongodb/blob/v6.0/CONTRIBUTING.rst>`_.
