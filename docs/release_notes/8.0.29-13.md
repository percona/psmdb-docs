...
# Percona Server for MongoDB {{ page.meta.version }} ({{date.8_0_29}})
...
This release fixes one critical and several high-severity vulnerabilities affecting earlier Percona Server for MongoDB 8.0.x versions. We strongly recommend upgrading to version {{ page.meta.version }} as soon as possible.
