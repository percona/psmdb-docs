...
This release fixes one critical and high-severity vulnerabilities affecting earlier Percona Server for MongoDB 8.0.x versions. We strongly recommend upgrading to version {{ page.meta.version }} as soon as possible.
