...
For the complete upstream changelog, see [MongoDB 8.3.8 Community Edition :octicons-link-external-16:](https://www.mongodb.com/docs/manual/release-notes/8.3-changelog/#8.3.8-changelog){:target="_blank"}.
