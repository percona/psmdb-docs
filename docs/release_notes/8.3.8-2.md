...
For the complete upstream changelog, see [MongoDB 8.0.29 Community Edition :octicons-link-external-16:](https://www.mongodb.com/docs/manual/release-notes/8.0-changelog/#std-label-8.0.29-changelog){:target="_blank"}.
