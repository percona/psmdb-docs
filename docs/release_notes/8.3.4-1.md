...
To upgrade to MongoDB 8.3 from a 8.0 deployment, the 8.0 deployment must have `featureCompatibilityVersion` set to 8.0. 
...
For the complete list of upstream changes, see Release Notes for MongoDB 8.3 :octicons-link-external-16:{:target="_blank"} and Compatibility Changes in MongoDB 8.3 :octicons-link-external-16:{:target="_blank"}.
...
MongoDB Shell (mongosh): 2.9.2 — [upstream release notes :octicons-link-external-16:](https://www.mongodb.com/docs/mongodb-shell/changelog/#v2.8.2){:target="_blank"}
