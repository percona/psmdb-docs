...
!!! info "Important"
    Percona Server for MongoDB 8.3.4-1 is in technical preview and is subject to change. We recommend that early adopters use this feature for testing purposes only.
...
Participate in monthly SWAG raffles, get early access to new product features, and join invite-only "ask me anything" sessions with database performance experts. Interested? Fill in the form at [squad.percona.com/mongodb](https://squad.percona.com/mongodb).
...
For the complete list of upstream changes, see Release Notes for [MongoDB 8.3 :octicons-link-external-16:]
(https://www.mongodb.com/docs/manual/release-notes/8.3-compatibility/){:target="_blank"} and[ Compatibility Changes in MongoDB 8.3 :octicons-link-external-16:](https://www.mongodb.com/docs/manual/release-notes/8.3-compatibility/){:target="_blank"}.
