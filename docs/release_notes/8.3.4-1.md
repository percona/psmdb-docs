...
- [SERVER-123081 octicons-link-external-16:](https://jira.mongodb.org/browse/SERVER-123081){:target="_blank"}[CVE-2026-13055](https://www.cve.org/CVERecord?id=CVE-2026-13055){:target="_blank"}: Fixed an issue in the `$_internalIndexKey` aggregation expression. An authenticated user with permission to run aggregation pipelines could submit a compound wildcard index specification that caused mongod to stop, resulting in a denial-of-service attack.
