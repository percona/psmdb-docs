...
- [MongoDB 8.0.26 Community Edition (includes changes from 8.0.24 and 8.0.25) :octicons-link-external-16:](https://www.mongodb.com/docs/manual/release-notes/8.0/#8.0.26---june-11--2026){:target="_blank"}
...
- [PSMDB-1977](https://perconadev.atlassian.net/browse/PSMDB-1977): Resolved an issue where Docker-based Percona Server for MongoDB instances could fail to start when replication settings were defined in `mongod.conf`.
