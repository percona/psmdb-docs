...
=======
Percona Server for MongoDB **{{ page.meta.version }}** includes updates from [MongoDB 6.0.29 Community Edition :octicons-link-external-16:](https://www.mongodb.com/docs/v6.0/release-notes/6.0-changelog/#6.0.29-changelog){:target="_blank"}

- Supports protocols and drivers of MongoDB Community **6.0.29**.
>>>>>>> 3315260e0ca0abb4d5b2d0e8fad76ad82f9dc6cb
