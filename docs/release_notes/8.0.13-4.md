title: Percona Server for MongoDB 8.0.13-4 ({{date.8_0_13}})
...
# Percona Server for MongoDB {{ page.meta.version }} ({{date.8_0_13}}) 
...
Percona Server for MongoDB {{ page.meta.version }} supports protocols and drivers of MongoDB Community 8.0.9 through 8.0.13.
...
This feature is available in [Percona Server for MongoDB Pro](../psmdb-pro.md) out of the box. [Become a Percona Customer](https://www.percona.com/about/contact) to enjoy all Pro features with little to no effort from your side. Alternatively, you can receive it by building Percona Server from the source code.
...
* [SERVER-106753](https://jira.mongodb.org/browse/SERVER-106753) - Fixed the issue with incorrect handling of incomplete data that may prevent `mongos` from accepting new connections. The issue affects deployments configured to use a load balancer like HAProxy and affects Percona Server for MongoDB Server v6.0 prior to 6.0.23, Percona Server for MongoDB Server v7.0 prior to 7.0.20 and Percona Server for MongoDB Server v8.0 prior to 8.0.13. We recommend users to upgrade to the latest version as soon as possible.
...
<!-- 8.0.13 -->
* [SERVER-77172](https://jira.mongodb.org/browse/SERVER-77172) - Fixed the issue with the  "abortExpiredTransactions" thread being stuck if it fails to check out a session by adding a timeout during the checkout
* [SERVER-82180](https://jira.mongodb.org/browse/SERVER-82180) - Preserved natural ordering across primaries/secondaries for capped collections and made dbhash check capped collections on natural order
* [SERVER-91686](https://jira.mongodb.org/browse/SERVER-91686) - Improved mongod's signal handler to print out current thread's command object
* [SERVER-94315](https://jira.mongodb.org/browse/SERVER-94315) - Ensured shard filtering is applied for non-simple collation find on sharded collection
* [SERVER-102670](https://jira.mongodb.org/browse/SERVER-102670) - Cleared errors before retrying for ordered time-series insert 
* [SERVER-107361](https://jira.mongodb.org/browse/SERVER-107361) - Fixed mixed schema detection in rollover determination
...
* [MongoDB 8.0.13 Community Edition](https://www.mongodb.com/docs/manual/release-notes/8.0/#8.0.13---upcoming).
