...
For the complete upstream changelog, see [MongoDB 8.3.9 Community Edition :octicons-link-external-16:](https://www.mongodb.com/docs/manual/release-notes/7.0-changelog/#std-label-7.0.39-changelog){:target="_blank"}.
