...
- The main openvex.json file contains the latest status information.
...
[CVE-2026-14881 :octicons-link-external-16:](https://www.cve.org/CVERecord?id=CVE-2026-14881){:target="_blank"}: Fixed an issue where imported Compass connections could not override advanced connection options, such as specifying a custom browser open command for the OIDC authentication flow, which was previously configurable only through global Compass settings.
