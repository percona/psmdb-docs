...
You can always find the main [openvex.json](https://percona.github.io/percona-server-mongodb/openvex.json) file with the latest vulnerability exploitability status, along with a dedicated OpenVEX file for each release, formatted `https://percona.github.io/percona-server-mongodb/percona-server-mongodb-<VERSION>.openvex.json`. This release {{ page.meta.version }} is available at: [https://percona.github.io/percona-server-mongodb/percona-server-mongodb-{{ page.meta.version }}.openvex.json](https://percona.github.io/percona-server-mongodb/percona-server-mongodb-{{ page.meta.version }}.openvex.json).
