...
- The `$scoreFusion` aggregation stage is now generally available (GA), and new expressions support hashing, Extended JSON conversion, binary subtypes, and `ObjectId` generation.
