...
### Extended platform support: RHEL 10 and Debian 13
...
| Orace Linux 10| x86_64, ARM64 |
| Alma Linux 10| x86_64, ARM64 |
| Debian 13 (Trixie) | x86_64, ARM64 |

!!! warning
    Percona Server for MongoDB 8.0.28-12 adds packages for two new operating systems: RHEL 10 and its compatible derivatives, and Debian 13. Neither platform is officially supported by upstream MongoDB yet. Percona is providing these packages ahead of upstream support based on our own build and test coverage.
