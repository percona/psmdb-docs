...
|---|---|---|
| RHEL 10 and compatible derivatives | x86_64, aarch64 | Yes |
| Debian 13 (Trixie) | x86_64, ARM64 | Yes |

To install on a new platform, enable the repository with `percona-release`, then follow the [installation steps](https://psmdb-docs-8-0-pr-1161.onrender.com/install/index.html) for your package manager.
