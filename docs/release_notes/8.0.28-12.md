...
!!! warning
    Percona Server for MongoDB 8.0.28-12 adds packages for Debian 13. This platform is not yet officially supported by upstream MongoDB. Percona is providing these packages ahead of upstream support, based on our own build and test coverage.
