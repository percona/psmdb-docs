...
Percona Server for MongoDB 8.0.28-12 adds packages for two new operating systems: 

| Platform | Architecture | `mongosh` |
|---|---|---|
| RHEL 10 and compatible derivatives | x86_64, ARM64 | Yes |
| Debian 13 (Trixie) | x86_64, ARM64 | Yes |
