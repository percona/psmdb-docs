...
To install on a new platform, enable the repository with `percona-release`, then follow the standard installation steps for your package manager.
...
-[SERVER-126247 :octicons-link-external-16:](https://jira.mongodb.org/browse/SERVER-126247){:target="_blank"} ([CVE-2026-13058 :octicons-link-external-16:](https://www.cve.org/CVERecord?id=CVE-2026-13058){:target="_blank"}): Fixed an issue where a specially crafted transaction command could cause the server to terminate unexpectedly, resulting in a denial- of-service.
...
- [SERVER-128473 :octicons-link-external-16:](https://jira.mongodb.org/browse/SERVER-128512){:target="_blank"} ([CVE-2026-13073 :octicons-link-external-16:](https://www.cve.org/CVERecord?id=CVE-2026-13073){:target="_blank"}): Fixed an issue where X.509-authenticated users could receive unintended role assignments when using PROXY protocol v2 over Unix domain sockets.
