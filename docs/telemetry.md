...
{"key" : "pillar_version","value" : "6.0.12-9"},
...
Starting with Percona Server for MongoDB 6.0.12-9, telemetry is enabled by default. If you decide not to send usage data to Percona, you can set the `PERCONA_TELEMETRY_DISABLE=1` environment variable for either the root user or in the operating system prior to the installation process.
