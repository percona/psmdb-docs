...
| Ubuntu 20.04| [6.0.21-18](release_notes/6.0.21-18.md) | Percona Server for MongoDB Pro remains available on Ubuntu 20.04 (Focal Fossa) enabling customers to continue using this operating system version for their deployments while receiving updates and support from Percona. |
