...
Percona Server for MongpDB Pro is available starting with version [7.0.4-2](https://docs.percona.com/percona-server-for-mongodb/release_notes/7.0.4-2.html).
