...
Percona Server for MongoDB 4.4 is based on [MongoDB Community Edition 4.4](https://docs.mongodb.com/manual/introduction/) and extends it with the functionality that is otherwise only available in MongoDB Enterprise Edition..
