...
* [Upgrading from MongoDB 5.0 Community Edition](#upgrading-from-mongodb-50-community-edition)
...
**NOTE**: MongoDB creates a user that belongs to two groups, which is a potential
security risk.  This is fixed in Percona Server for MongoDB: the user is included only in the
...
**WARNING**: Before starting the upgrade, we recommend to perform a full
backup of your data.
