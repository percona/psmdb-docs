...
* [Upgrading from MongoDB 4.2 Community Edition](#upgrading-from-mongodb-42-community-edition)

* [Minor upgrade of Percona Server for MongoDB](#minor-upgrade-of-percona-server-for-mongodb)

## Upgrading from MongoDB 4.2 Community Edition
...
=== "Upgrade on Debian and Ubuntu"
     ...
     2. Check for installed packages:
         ...
         ii  mongodb-org-mongos               4.2.22                       amd64        MongoDB sharded cluster query router
         ii  mongodb-org-server               4.2.22                       amd64        MongoDB database server
         ii  mongodb-org-shell                4.2.22                       amd64        MongoDB shell client
         ii  mongodb-org-tools                4.2.22                       amd64        MongoDB tools
         ```
...
=== "Upgrade on Red Hat Enterprise Linux and derivatives"
     ...
     2. Check for installed packages:
         ...
         mongodb-org-server-4.2.22-1.el8.x86_64
         mongodb-org-mongos-4.2.22-1.el8.x86_64
         mongodb-org-tools-4.2.22-1.el8.x86_64
         ```
