...
- The set of dependencies for your operating system. The following table lists dependencies for Ubuntu 22.04 and Red Hat Enterprise 9 and compatible derivatives:
   ...
   | --------------------------------|---------------------------
   | RedHat Enterprise Linux/ CentOS 9 / Oracle Linux 9 / Rocky Linux 9| gcc gcc-c++ cmake curl binutils-devel openssl-devel openldap-devel krb5-devel libcurl-devel cyrus-sasl-devel bzip2-devel zlib-devel lz4-devel xz-devel e2fsprogs-devel|
